        ...
        where TChannel : IChannel
    {
        ...
        protected override void OnOpen(TimeSpan timeout)
        {
            ...
            using (var createSessionReqMsg = Message.CreateMessage(MessageVersion.Default, Actions.CreateSessionRequest, new CreateSessionRequest()))
            {
                ...
                try
                {
                    _queueReader = Binding.QueueReaderWriterFactory.CreateReader(Binding.ConnectionFactory, localUri.Exchange, localUri.QueueName, localUri.IsDurable, localUri.DeleteOnClose, localUri.TimeToLive, msgThrottle, timer.RemainingTime, ConcurrentOperationManager.Token);
